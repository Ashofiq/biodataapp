...
<html lang="en">
  <head>
    ...
    <title>Dashboard | Biodata App</title>
    <!-- CSS files -->
  ...
  <body id="app">
            ...
            <div class="row text-center align-items-center flex-row-reverse">
              <div class="col-lg-auto ms-lg-auto">
                ...
                <li class="list-inline-item">
                    <a href="https://github.com/Ashofiq" target="_blank" class="link-secondary" rel="noopener">
              ...
              <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                <ul class="list-inline list-inline-dots mb-0">
                  <li class="list-inline-item">
                    Copyright &copy; 2022
                    <a href="." class="link-secondary">Ahmad shofiq</a>.
                    All rights reserved.
                  </li>
                  <li class="list-inline-item">
    ...
    <script src="{{asset('backend/dist/libs/jsvectormap/dist/js/jsvectormap.min.js')}}"></script>
    <script src="{{asset('backend/dist/libs/jsvectormap/dist/maps/world.js')}}"></script>
    <script src="{{asset('backend/dist/libs/jsvectormap/dist/maps/world-merc.js')}}"></script>
    <!-- Tabler Core -->
